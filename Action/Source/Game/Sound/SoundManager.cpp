...
namespace {
	constexpr const char* FilePath1[SoundManager::TagID::NUM_MAX] = {
		...
		"Data/Sound/SE/4.Guard.mp3",
		"Data/Sound/SE/5.Jump.mp3",
		"Data/Sound/SE/6.SkillAttack.mp3",
		"Data/Sound/SE/7.ElephantNormalAttack.mp3",
		"Data/Sound/SE/8.ElephantStrongAttack.mp3",
		"Data/Sound/SE/9.ElephantLunges.mp3",
		"Data/Sound/SE/10.ElephantCry.mp3",
		"Data/Sound/SE/11.WolfAttack.mp3",
		"Data/Sound/SE/12.MobWolfDeath.mp3",
		"Data/Sound/SE/13.BossWolfDeath.mp3",
		...
		"Data/Sound/SE/20.DropItem.mp3",
		"Data/Sound/SE/21.HitPoints.mp3",
		"Data/Sound/SE/22.SkillPoints.mp3",
