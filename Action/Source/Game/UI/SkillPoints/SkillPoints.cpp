...
namespace {
	const char* FILE_PATH[SkillPoints::TagGraphicsNum::GRAPHICS_NUM] = {			//画像パス
	"Data/UI/SkillPoints.png",
	"Data/UI/Gray.png",
	};

	const int DIVIDE_NUM[SkillPoints::TagGraphicsNum::GRAPHICS_NUM] = {			//画像の分割数
		1,
		1,
	};
	...
	const VECTOR	HEAD_POS = { 50.0f,150.0f,0.0f };	//先頭座標
