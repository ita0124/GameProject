...
namespace {
	const char* FILE_PATH[Stamina::TagGraphicsNum::GRAPHICS_NUM] = {			//画像パス
	"Data/UI/Stamina.png",
	"Data/UI/Gray.png",
	};

	const int DIVIDE_NUM[Stamina::TagGraphicsNum::GRAPHICS_NUM] = {			//画像の分割数
		1,
		1,
	};
	...
	const VECTOR	HEAD_POS = { 50.0f,100.0f,0.0f };	//先頭座標
